...
${OBJECTDIR}/src/stopwatch.o: src/stopwatch.cc 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -g -Iinclude -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/stopwatch.o src/stopwatch.cc
...
${TESTDIR}/src/tests/basictest.o: src/tests/basictest.cc 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -g -Iinclude -I. -I. `cppunit-config --cflags` -MMD -MP -MF "$@.d" -o ${TESTDIR}/src/tests/basictest.o src/tests/basictest.cc
...
${OBJECTDIR}/src/stopwatch_nomain.o: ${OBJECTDIR}/src/stopwatch.o src/stopwatch.cc 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g -Iinclude -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/stopwatch_nomain.o src/stopwatch.cc;\
	else  \
